...
import numpy as np
from qti.aisw.converters.common.converter_ir.op_adapter import RolledLstmOp, ReshapeOp, ConstantOp
...
class LstmLayerBuilder(LayerBuilder):
    ...
    @classmethod
    def prepare_params_as_constants(cls, graph, params):
    ...
    def build_layer(self, ir_graph, converter_context, descriptor, input_descriptors, output_descriptors):
        ...
        self.prepare_params_as_constants(ir_graph, params_dict)
