...
class Span(Object):
    ...
    def __init__(self, source_name, line, end_line, column, end_column, op_type='', output_names=[]):
        self.__init_handle_by_constructor__(
            _ffi_api.Span, source_name, line, end_line, column, end_column, op_type, output_names
        )
